      ...
      <Column className="bg-white_A700 font-poppins items-start justify-start mx-[auto] w-[100%]">
        ...
        <Row className="items-start justify-start 2xl:ml-[111px] 3xl:ml-[133px] ml-[148px] lg:ml-[86px] xl:ml-[98px] 2xl:mr-[105px] 3xl:mr-[126px] mr-[140px] lg:mr-[81px] xl:mr-[93px] lg:mt-[43px] xl:mt-[50px] 2xl:mt-[56px] 3xl:mt-[67px] mt-[75px] w-[85%]">
          ...
          <Grid className="lg:gap-[18px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] gap-[32px] grid grid-cols-2 lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] w-[83%]">
            ...
            <Column className="bg-gray_100 items-center justify-start lg:py-[25px] xl:py-[28px] 2xl:py-[32px] 3xl:py-[38px] py-[43px] w-[100%]">
              <Row className="bg-gray_100 items-center justify-center mx-[auto] w-[54%]">
                <Image
                  src="img_dress_4.svg"
            ...
            <Column className="bg-gray_100 items-center justify-start lg:py-[25px] xl:py-[28px] 2xl:py-[32px] 3xl:py-[38px] py-[43px] w-[100%]">
              <Row className="bg-gray_100 items-center justify-center mx-[auto] w-[58%]">
                <Image
                  src="img_bra_1.svg"
                  className="xl:h-[107px] 2xl:h-[121px] 3xl:h-[145px] h-[160px] lg:h-[94px] object-contain xl:w-[106px] 2xl:w-[120px] 3xl:w-[144px] w-[160px] lg:w-[93px]"
                  alt="Bra"
