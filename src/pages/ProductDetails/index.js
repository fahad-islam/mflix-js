        ...
        <Row className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] w-[85%]">
          ...
          <Column className="items-start lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] w-[49%]">
            ...
            <div className="2xl:mr-[7px] 2xl:mt-[42px] 3xl:mr-[9px] 3xl:mt-[50px] bg-transparent border-bw lg:mr-[5px] lg:mt-[32px] mr-[10px] mt-[56px] w-[31%] xl:mr-[6px] xl:mt-[37px] input-wrap">
              <Image
                src="img_cart.svg"
                className="absolute h-[32px] right-[45.5px] border-bw bg-transparent lg:h-[19px] lg:right-[26px] lg:inset-y-[11px] xl:h-[22px] xl:right-[30px] xl:inset-y-[13px] 2xl:h-[25px] 2xl:right-[34px] 2xl:inset-y-[15px] 3xl:h-[29px] 3xl:right-[40px] 3xl:inset-y-[18px] inset-y-[20.045px]"
                alt="Cart"
              />
              <Button className="bg-gray_800 border-bw font-bold lg:pl-[20px] xl:pl-[23px] 2xl:pl-[26px] 3xl:pl-[31px] pl-[35px] lg:pr-[51px] xl:pr-[58px] 2xl:pr-[65px] 3xl:pr-[78px] pr-[87.5px] lg:py-[11px] xl:py-[13px] 2xl:py-[15px] 3xl:py-[18px] py-[20.045px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-white_A700 w-[100%]">{`Add to Cart`}</Button>
            </div>
          </Column>
        </Row>
